/*
 * KindEditor 4.1.10 (2013-11-23), Copyright (C) kindsoft.net, Licence:
 * http://www.kindsoft.net/license.php
 */(function(
		b, d) {
	function f(a) {
		if (!a)
	...
	function G(a, c, g) {
		a.addEventListener ? a.addEventListener(c, g, fb) : a.attachEvent
				&& a.attachEvent("on" + c, g)
	}
	function C(a, c, g) {
		a.removeEventListener ? a.removeEventListener(c, g, fb) : a.detachEvent
	...
	function $(a, c, g) {
		...
		E(a, "keydown", function(b) {
					b.ctrlKey && b.which == c && !b.shiftKey && !b.altKey
							&& (g.call(a), b.stop())
				})
	}
	function M(a) {
	...
	function K(a) {
		for (var c = {}, g = /\s+(?:([\w\-:]+)|(?:([\w\-:]+)=([^\s"'<>]+))|(?:([\w\-:"]+)="([^"]*)")|(?:([\w\-:"]+)='([^']*)'))(?=(?:\s|\/|>)+)/g, b; b = g
				.exec(a);) {
	...
	function O(a, c) {
		return a = /\s+class\s*=/.test(a) ? a.replace(
	...
	function R(a, c, g, b) {
		...
		if (b === d)
			var w = location.pathname.match(/^(\/.*)\//), b = w ? w[1] : "";
		var i;
		if (i = /^(\w+:\/\/[^\/]*)/.exec(a)) {
			if (i[1] !== g)
				return a
			...
			return a;
		/^\//.test(a) ? a = g + t(a.substr(1)) : /^\w+:\/\//.test(a)
				|| (a = g + t(b + "/" + a));
		c === "relative" ? a = k(g + b, 0).substr(2) : c === "absolute"
				&& a.substr(0, g.length) === g && (a = a.substr(g.length));
		return a
	}
	function H(a, c, g, b, d) {
		a == null && (a = "");
		var g = g || "", b = q(b, !1), d = q(d, "\t"), k = "xx-small,x-small,small,medium,large,x-large,xx-large"
				.split(","), a = a.replace(
				/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/ig, function(a, c,
						g, b) {
					return c + g.replace(/<(?:br|br\s[^>]*)>/ig, "\n") + b
				}), a = a.replace(/<(?:br|br\s[^>]*)\s*\/?>\s*<\/p>/ig, "</p>"), a = a
				.replace(/(<(?:p|p\s[^>]*)>)\s*(<\/p>)/ig, "$1<br />$2"), a = a
				.replace(/\u200B/g, ""), a = a.replace(/\u00A9/g, "&copy;"), a = a
				.replace(/\u00AE/g, "&reg;"), a = a.replace(/<[^>]+/g,
				function(a) {
		...
		var i = [], a = a
				.replace(
						...
						function(a, f, n, l, o, j, s) {
							var f = f || "", n = n || "", m = l.toLowerCase(), r = o
									|| "", l = j ? " " + j : "", s = s || "";
							if (c && !w[m])
								return "";
							l === "" && hb[m] && (l = " /");
							...
							if (r !== "") {
								...
								if (m === "font") {
									...
									h(p, function(a, c) {
										if (a === "color")
											v.color = c, delete p[a];
										a === "size"
												&& (v["font-size"] = k[parseInt(
														c, 10)
														- 1]
														|| "", delete p[a]);
										a === "face"
												&& (v["font-family"] = c, delete p[a]);
										a === "style" && (q = c)
									});
									q && !/;$/.test(q) && (q += ";");
									h(v, function(a, c) {
								...
								h(p, function(a, b) {
									...
									(c && a !== "style" && !w[m]["*"]
											&& !w[m][a] || m === "body"
											&& a === "contenteditable" || /^kindeditor_\d+$/
											.test(a))
											&& delete p[a];
									if (a === "style" && b !== "") {
										var d = M(b);
	...
	function U(a, c) {
		a = a.replace(/<meta[\s\S]*?>/ig, "").replace(/<![\s\S]*?>/ig, "")
				.replace(/<style[^>]*>[\s\S]*?<\/style>/ig, "").replace(
						/<script[^>]*>[\s\S]*?<\/script>/ig, "").replace(
						/<w:[^>]+>[\s\S]*?<\/w:[^>]+>/ig, "").replace(
						/<o:[^>]+>[\s\S]*?<\/o:[^>]+>/ig, "").replace(
						/<xml>[\s\S]*?<\/xml>/ig, "").replace(
						/<(?:table|td)[^>]*>/ig, function(a) {
							return a.replace(/border-bottom:([#\w\s]+)/ig,
									"border:$1")
						});
		return H(a, c)
	}
	...
	function kb(a, c) {
		...
		/\D/.test(g) ? w += "width:" + g + ";" : g > 0
				&& (w += "width:" + g + "px;");
		/\D/.test(b) ? w += "height:" + b + ";" : b > 0
				&& (w += "height:" + b + "px;");
		g = /realaudio/i.test(d) ? "ke-rm" : /flash/i.test(d)
				? "ke-flash"
				: "ke-media";
		g = '<img class="' + g + '" src="' + a + '" ';
		w !== "" && (g += 'style="' + w + '" ');
	...
	function Fa(a, c) {
		...
		function d(a, c, g) {
			var t = [];
			(a = (g.ownerDocument || g).getElementById(a.replace(/\\/g, "")))
					&& b(c, a.nodeName) && Da(g, a) && t.push(a);
			return t
		}
		function k(a, c, g) {
			...
			if (g.getElementsByClassName) {
				...
				for (w = d.length; k < w; k++)
					i = d[k], b(c, i.nodeName) && t.push(i)
			} else if (d.querySelectorAll) {
				d = d.querySelectorAll((g.nodeName !== "#document" ? g.nodeName
						+ " " : "")
						+ c + "." + a);
				k = 0;
				for (w = d.length; k < w; k++)
					i = d[k], Da(g, i) && t.push(i)
			} else {
				d = g.getElementsByTagName(c);
				a = " " + a + " ";
				k = 0;
				for (w = d.length; k < w; k++)
					if (i = d[k], i.nodeType == 1)
						(c = i.className) && (" " + c + " ").indexOf(a) > -1
								&& t.push(i)
			}
			return t
		}
		function w(a, c, b, d) {
			for (var t = [], b = d.getElementsByTagName(b), V = 0, k = b.length; V < k; V++)
				d = b[V], d.nodeType == 1
						&& (c === null
								? Ea(d, a) !== null && t.push(d)
								: c === g(Ea(d, a)) && t.push(d));
			return t
		}
		function i(a, c) {
			var g = [], e, f = (e = /^((?:\\.|[^.#\s\[<>])+)/.exec(a))
					? e[1]
					: "*";
			if (e = /#((?:[\w\-]|\\.)+)$/.exec(a))
				g = d(e[1], f, c);
				...
				if (g === "id")
					...
					g = [];
					e = (c.ownerDocument || c).getElementsByName(e.replace(
							/\\/g, ""));
					for (var Z, h = 0, l = e.length; h < l; h++)
						Z = e[h], b(f, Z.nodeName) && Da(c, Z)
								&& Z.getAttribute("name") !== null && g.push(Z);
					f = g
				} else
					f = w(g, e, f, c);
				g = f
		...
		for (var c = c || document, f = [], l, o = /((?:\\.|[^\s>])+|[\s>])/g; l = o
				.exec(a);)
			l[1] !== " " && f.push(l[1]);
		l = [];
		if (f.length == 1)
				...
				if (v > 0) {
					...
					for (E = l.length; q < E; q++) {
						...
						for (u = j.length; B < u; B++)
							p = j[B], o ? r === p.parentNode && s.push(p) : s
									.push(p)
					}
					l = s
				} else
	...
	function Nb(a, c) {
		if (a.nodeType == 1) {
			var g = ia(a);
			try {
				a.innerHTML = '<img id="__kindeditor_temp_tag__" width="0" height="0" style="display:none;" />'
						+ c;
	...
	function Ob(a, c) {
		var g = ja(a), b = p(c), d = "";
		g.getComputedStyle ? (g = g.getComputedStyle(a, null), d = g[b]
				|| g.getPropertyValue(c) || a.style[b]) : a.currentStyle
				&& (d = a.currentStyle[b] || a.style[b]);
		return d
	}
	function X(a) {
		a = a || document;
	...
	function na(a) {
		var a = a || document, c;
		F || Pb || Qa
				? (c = X(a).scrollLeft, a = X(a).scrollTop)
				: (c = ja(a).scrollX, a = ja(a).scrollY);
		return {
			x : c,
			y : a
		}
	...
	function Ra(a, c, g) {
		function b(d, t, V) {
			...
			c
					&& (i = d.cloneNode(!0), i = t > 0 ? i.splitText(t) : i, V < k
							&& i.splitText(V - t));
			if (g) {
				var w = d;
		...
		function k(d, t) {
			for (var m = d.firstChild, s; m;) {
				...
				if (h > 0)
					if (m.nodeType == 1)
						if (l >= 0 && n <= 0)
							c && t.appendChild(m.cloneNode(!0)), g && e.push(m);
						else {
							var j;
							...
							&& (m = m == f.startContainer ? b(m, f.startOffset,
									m.nodeValue.length) : m == f.endContainer
									? b(m, 0, f.endOffset)
									: b(m, 0, m.nodeValue.length), c))
						try {
							t.appendChild(m)
						} catch (r) {
						}
		...
		var i = a.doc, e = [], f = a.cloneRange().down(), h = -1, l = -1, n = -1, o = -1, m = a
				.commonAncestor(), s = i.createDocumentFragment();
		if (m.nodeType == 3)
			return m = b(m, a.startOffset, a.endOffset), c && s.appendChild(m), d(), c
					? s
					: a;
		k(m, s);
		g && a.up().collapse(!0);
	...
	function mb(a, c) {
		...
		for (var l = 0, n = k.length; l < n; l++) {
			...
			if (o.nodeType == 1) {
				...
				j.isControl()
						&& (s = g.createElement("span"), j.after(s), r = s, e += j
								.text().replace(/\r\n|\n|\r/g, "").length);
				ua(m, r);
				...
				o.nodeType == 3
						&& (h.moveStart("character", o.nodeValue.length), e += o.nodeValue.length);
			f < 0 && (w = o)
		}
		if (f < 0 && w.nodeType == 1)
			return {
		...
		if (f > 0 && w.nodeType == 3)
			for (g = w.previousSibling; g && g.nodeType == 3;)
				e -= g.nodeValue.length, g = g.previousSibling;
		return {
			node : w,
			offset : e
		}
	...
	function nb(a, c) {
		...
		if (a.nodeType == 1 && a.childNodes.length > 0) {
			...
			if (!k)
				return b;
			if (i(k).name === "head")
				return c === 1 && (d = !0), c === 2 && (d = !1), b.collapse(d), b;
			if (k.nodeType == 1) {
				var w = i(k), e;
				w.isControl()
						&& (e = g.createElement("span"), d ? w.before(e) : w
								.after(e), k = e);
				ua(b, k);
				b.collapse(d);
				e && i(e).remove();
	...
	function ob(a) {
		...
		if (Y) {
			if (a.item)
				return g = ia(a.item(0)), g = new aa(g), g
						.selectNode(a.item(0)), g;
	...
	function sb(a, c, g) {
		...
		if (a.type === 1 && (c = qb(c), c[g])) {
			for (var g = c[g].split(","), c = !1, b = 0, d = g.length; b < d; b++) {
				...
				var i = /^(\.?)([^=]+)(?:=([^=]*))?$/.exec(k), k = i[2];
				i[1] ? (k = p(k), a[0].style[k] && (a[0].style[k] = "")) : a
						.removeAttr(k)
			}
			c && a.remove(!0)
		}
	...
	function tb(a) {
		a.nodeName
				&& (a = ia(a), a = Sa(a).selectNodeContents(a.body)
						.collapse(!1));
		return new va(a)
	}
	function Xa(a) {
		...
		b.mousedown(function(a) {
					function d(a) {
						a.preventDefault();
						var c = i(ia(a.target)), t = fa((c.data("pos-x") || 0)
								+ a.pageX - j), a = fa((c.data("pos-y") || 0)
								+ a.pageY - r);
					...
					function f(a) {
						a.preventDefault();
						i(k).unbind("mousemove", d).unbind("mouseup", f)
								.unbind("selectstart", e);
						h.releaseCapture && h.releaseCapture()
					}
					a.stopPropagation();
					var h = b.get(), n = l(c.css("left")), o = l(c.css("top")), m = c
							.width(), s = c.height(), j = a.pageX, r = a.pageY;
					t && t();
	...
	function cb(a, c) {
		var g = document.getElementsByTagName("head")[0]
				|| (da ? document.body : document.documentElement), b = document
		...
		b.onload = b.onreadystatechange = function() {
			if (!this.readyState || this.readyState === "loaded")
				c && c(), b.onload = b.onreadystatechange = null, g
						.removeChild(b)
		}
	}
	function zb(a) {
	...
	function db(a) {
		for (var c = document.getElementsByTagName("head")[0]
				|| (da ? document.body : document.documentElement), g = document
				.createElement("link"), b = zb(R(a, "absolute")), d = i(
				'link[rel="stylesheet"]', c), k = 0, w = d.length; k < w; k++)
			...
			if (a.useContextmenu) {
				if (a._contextmenus.length !== 0) {
					...
					for (h(a._contextmenus, function() {
						if (this.title == "-")
							b.push(this);
						else if (this.cond && this.cond()
								&& (b.push(this), this.width && this.width > g))
							g = this.width
					...
					if (b.length > 0) {
						...
						c.clientY + e >= k.clientHeight - 100
								&& w.pos(w.x, l(w.y) - e);
		...
		if (!(F && b !== "br") && (!la || !(N < 3 && b !== "p"))
			...
			i(g).keyup(function(d) {
				if (!(d.which != 13 || d.shiftKey || d.ctrlKey || d.altKey)
						&& b != "br")
					if (la) {
						var d = c.cmd.commonAncestor("p"), t = c.cmd
								.commonAncestor("a");
						t
								&& t.text() == ""
								&& (t.remove(!0), c.cmd.range
										.selectNodeContents(d[0]).collapse(!0), c.cmd
										.select())
					} else if (c.cmd.selection(), d = a(c.cmd.range), !(d == "marquee" || d == "select"))
						if (k[d] || ea(g, "formatblock", "<p>"), d = c.cmd
								.commonAncestor("div")) {
	...
	function Eb(a, c) {
		...
		if (a.length === 0)
			return this;
		g.designMode
				? (d = this.cmd.range, k = d.createBookmark(!0), k.html = b.innerHTML)
				: k = {
					html : b.innerHTML
				};
		Db(c, k);
		...
		g.designMode ? (g.html(e.html), e.start
				&& (d.moveToBookmark(e), this.select())) : i(b)
				.html(ha(e.html));
		return this
	}
	function Ba(a) {
	...
	function Fb(a, c) {
		...
		if ((b = i(a)) && b.length !== 0) {
			...
			if (ca[d.langType])
				return g(d);
			cb(		d.langPath + d.langType + ".js?ver="
							+ encodeURIComponent(i.DEBUG ? Ja : Ka),
					function() {
						g(d)
					});
			return d
	...
	if (!b.KindEditor) {
		...
		var Ka = "4.1.10 (2013-11-23)", J = navigator.userAgent.toLowerCase(), F = J
				.indexOf("msie") > -1
				&& J.indexOf("opera") == -1, Pb = J.indexOf("msie") == -1
				&& J.indexOf("trident") > -1, la = J.indexOf("gecko") > -1
				&& J.indexOf("khtml") == -1, ka = J.indexOf("applewebkit") > -1, Qa = J
				.indexOf("opera") > -1, Wb = J.indexOf("mobile") > -1, Xb = /ipad|iphone|ipod/
				.test(J), da = document.compatMode != "CSS1Compat", Y = !b.getSelection, N = (J = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/
				.exec(J)) ? J[1] : "0", Ja = (new Date).getTime(), fa = Math.round, i = {
			DEBUG : !1,
			VERSION : Ka,
			IE : F,
			GECKO : la,
		...
		i.basePath = function() {
			for (var a = document.getElementsByTagName("script"), c, g = 0, b = a.length; g < b; g++)
				if (c = a[g].src || "", /kindeditor[\w\-\.]*\.js/.test(c))
		...
		i.options = {
			...
			htmlTags : {
				...
				div : ["id", "class", "align", ".border", ".margin",
				...
				img : ["id", "class", "src", "width", "height", "border",
						"alt", "title", "align", ".width", ".height", ".border"],
				...
				"br,tbody,tr,strong,b,sub,sup,em,i,u,strike,s,del" : ["id",
						"class"],
				iframe : ["id", "class", "src", "frameborder", "width",
						"height", ".width", ".height"]
			},
			layout : '<div class="container"><div class="toolbar"></div><div class="edit"></div><div class="statusbar"></div></div>'
		};
		var fb = !1, Ib = z("8,9,13,32,46,48..57,59,61,65..90,106,109..111,188,190..192,219..222"), J = z("33..40"), eb = {};
		h(Ib, function(a, c) {
					eb[a] = c
				});
		h(J, function(a, c) {
		...
		var Zb = "altKey,attrChange,attrName,bubbles,button,cancelable,charCode,clientX,clientY,ctrlKey,currentTarget,data,detail,eventPhase,fromElement,handler,keyCode,metaKey,newValue,offsetX,offsetY,originalTarget,pageX,pageY,prevValue,relatedNode,relatedTarget,screenX,screenY,shiftKey,srcElement,target,toElement,view,wheelDelta,which"
				.split(",");
		A(u, {
					init : function(a, c) {
						...
						if (!g.relatedTarget && g.fromElement)
							g.relatedTarget = g.fromElement === g.target
									? g.toElement
									: g.fromElement;
						if (g.pageX == null && g.clientX != null) {
							var t = b.documentElement, b = b.body;
							g.pageX = g.clientX
									+ (t && t.scrollLeft || b && b.scrollLeft || 0)
									- (t && t.clientLeft || b && b.clientLeft || 0);
							g.pageY = g.clientY
									+ (t && t.scrollTop || b && b.scrollTop || 0)
									- (t && t.clientTop || b && b.clientTop || 0)
						}
						if (!g.which
								&& (g.charCode || g.charCode === 0
										? g.charCode
										: g.keyCode))
						...
						if (!g.which && g.button !== d)
							g.which = g.button & 1 ? 1 : g.button & 2
									? 3
									: g.button & 4 ? 2 : 0;
						switch (g.which) {
							case 186 :
		...
		A(P, {
			...
			attr : function(a, c) {
				...
				if (c === d)
					return c = g.length < 1 ? null : Ea(g[0], a), c === null
							? ""
							: c;
				g.each(function() {
							Oa(this, a, c)
			...
			removeClass : function(a) {
				this.each(function() {
							if (n(a, this.className, " "))
								this.className = m(this.className.replace(
										RegExp("(^|\\s)" + a + "(\\s|$)"), " "))
						});
				return this
			},
			...
			val : function(a) {
				if (a === d) {
					...
					return this.each(function() {
								Hb[Pa(this)] ? this.value = a : Oa(this,
										"value", a)
							}), this
			},
			css : function(a, c) {
			...
			pos : function() {
				...
				if (a)
					if (a.getBoundingClientRect)
						a = a.getBoundingClientRect(), g = na(this.doc), c = a.left
								+ g.x, g = a.top + g.y;
					else
						for (; a;)
							c += a.offsetLeft, g += a.offsetTop, a = a.offsetParent;
				return {
					x : fa(c),
					y : fa(g)
				}
			...
			after : function(a) {
				this.each(function() {
							this.nextSibling
									? this.parentNode.insertBefore(i(a)[0],
											this.nextSibling)
			...
			children : function() {
				...
				for (var a = [], c = this[0].firstChild; c;)
					(c.nodeType != 3 || m(c.nodeValue) !== "") && a.push(c), c = c.nextSibling;
				return new P(a)
			},
			first : function() {
				var a = this.children();
			...
			scan : function(a, c) {
				...
				if (!(this.length < 1))
					return c = c === d ? !0 : c, b(this[0]), this
			}
		});
		h(
			...
			if (!(a === d || a === null)) {
				if (typeof a === "string") {
					...
					if (a.length !== e || /<.+>/.test(a)) {
						var e = (c ? c.ownerDocument || c : document)
								.createElement("div"), t = [];
						e.innerHTML = '<img id="__kindeditor_temp_tag__" width="0" height="0" style="display:none;" />'
								+ a;
		...
		A(aa, {
			...
			setStart : function(a, c) {
				...
				if (this.endContainer === b)
					this.endContainer = a, this.endOffset = c;
				return lb(this)
			},
			setEnd : function(a, c) {
				var b = this.doc;
				...
				if (this.startContainer === b)
					this.startContainer = a, this.startOffset = c;
				return lb(this)
			},
			...
			setStartAfter : function(a) {
				return this
						.setStart(a.parentNode || this.doc, i(a).index() + 1)
			},
			...
			compareBoundaryPoints : function(a, c) {
				...
				if (Y) {
					...
					var k, e, f, h;
					if (a === sa || a === ta)
						k = this.startContainer, f = this.startOffset;
					if (a === ra || a === oa)
						k = this.endContainer, f = this.endOffset;
					if (a === sa || a === ra)
						e = c.startContainer, h = c.startOffset;
					if (a === oa || a === ta)
						e = c.endContainer, h = c.endOffset;
					if (k === e)
						return k = f - h, k > 0 ? 1 : k < 0 ? -1 : 0;
			...
			cloneRange : function() {
				return (new aa(this.doc)).setStart(this.startContainer,
			...
			insertNode : function(a) {
				...
				if (a.nodeName.toLowerCase() === "#document-fragment")
					k = a.firstChild, e = a.lastChild, h = a.childNodes.length;
				c.nodeType == 1
						? (f = c.childNodes[b])
								? (c.insertBefore(a, f), c === d && (i += h))
								: c.appendChild(a)
						: c.nodeType == 3
								&& (b === 0
										? (c.parentNode.insertBefore(a, c), c.parentNode === d
												&& (i += h))
										: b >= c.nodeValue.length
												? c.nextSibling
														? c.parentNode
																.insertBefore(
																		a,
												...
												: (f = b > 0
														? c.splitText(b)
														: c, c.parentNode
														.insertBefore(a, f), c === d
														&& (d = f, i -= b)));
				k ? this.setStartBefore(k).setEndAfter(e) : this.selectNode(a);
				if (this.compareBoundaryPoints(oa, this.cloneRange().setEnd(d,
								i)) >= 1)
					return this;
			...
			isControl : function() {
				...
				return a.nodeType == 1 && a === b && c + 1 === d
						&& i(a.childNodes[c]).isControl()
			},
			get : function(a) {
				var c = this.doc;
				if (!Y) {
					c = c.createRange();
					try {
						c.setStart(this.startContainer, this.startOffset), c
				...
				if (a && this.isControl())
					return c = c.body.createControlRange(), c
							.addElement(this.startContainer.childNodes[this.startOffset]), c;
				a = this.cloneRange().down();
				c = c.body.createTextRange();
				c.setEndPoint("StartToStart", nb(a.startContainer,
								a.startOffset));
			...
			down : function() {
				function a(a, b, d) {
					if (a.nodeType == 1
							&& (a = i(a).children(), a.length !== 0)) {
						var k, e, f, h;
						b > 0 && (k = a.eq(b - 1));
						b < a.length && (e = a.eq(b));
						if (k && k.type == 3)
							f = k[0], h = f.nodeValue.length;
			...
			up : function() {
				function a(a, b, d) {
					a.nodeType == 3
							&& (b === 0 ? d ? c.setStartBefore(a) : c
									.setEndBefore(a) : b == a.nodeValue.length
									&& (d ? c.setStartAfter(a) : c
											.setEndAfter(a)))
				}
				var c = this;
				a(c.startContainer, c.startOffset, !0);
			...
			createBookmark : function(a) {
				...
				if (!this.collapsed)
					c = b.cloneNode(!0), c.id = "__kindeditor_bookmark_end_"
							+ Kb++ + "__";
				c
						&& this.cloneRange().collapse(!1).insertNode(c)
								.setEndBefore(c);
			...
			moveToBookmark : function(a) {
				var c = this.doc, b = i(a.start, c), a = a.end
						? i(a.end, c)
						: null;
				if (!b || b.length < 1)
					return this;
		...
		A(va, {
			...
			selection : function(a) {
				...
				b = Y
						&& (!d || !d.item
								&& d.parentElement().ownerDocument !== c)
						? null
						: d;
				this.sel = Ta(c);
				if (b)
					return this.range = Sa(b), i(this.range.startContainer).name == "html"
							&& this.range.selectNodeContents(c.body)
									.collapse(!1), this;
				a && this.range.selectNodeContents(c.body).collapse(!1);
				return this
			},
			select : function(a) {
				var a = q(a, !0), c = this.sel, b = this.range.cloneRange()
						.shrink(), d = b.startContainer, e = b.startOffset, k = ia(d), f = this.win, h, l = !1;
				if (a && d.nodeType == 1 && b.collapsed) {
					...
					if (ka
							&& (a = d.childNodes, i(d).isInline() || e > 0
									&& i(a[e - 1]).isInline() || a[e]
									&& i(a[e]).isInline()))
						b.insertNode(k.createTextNode("\u200b")), l = !0
				}
				if (Y)
					try {
						h = b.get(!0), h.select()
					...
					l && b.collapse(!1), h = b.get(!0), c.removeAllRanges(), c
							.addRange(h), k !== document
							&& (b = i(h.endContainer).pos(), f.scrollTo(b.x,
									b.y));
				f.focus();
				return this
			},
			wrap : function(a) {
				...
				c.enlarge();
				var e = c.createBookmark(), a = c.commonAncestor(), k = !1;
				i(a).scan(function(a) {
					if (!k && a == e.start)
						k = !0;
					else if (k) {
						...
						a : {
							for (d = c; d && d.name != "body";) {
								if (Ma[d.name] || d.name == "div"
										&& d.hasClass("ke-script")) {
									d = !0;
									break a
								}
								d = d.parent()
						...
						if (!d && c.type == 3 && m(a.nodeValue).length > 0) {
							for (var f; (f = c.parent()) && f.isStyle()
									&& f.children().length == 1;)
								c = f;
							f = b;
							f = f.clone(!0);
							if (c.type == 3)
								Wa(f).append(c.clone(!1)), c.replaceWith(f);
							else {
								for (var a = c, h; (h = c.first())
										&& h.children().length == 1;)
									c = h;
								h = c.first();
								for (c = c.doc.createDocumentFragment(); h;)
									c.appendChild(h[0]), h = h.next();
								h = a.clone(!0);
								d = Wa(h);
								for (var l = h, n = !1; f;) {
									for (; l;)
										l.name === f.name
												&& (Qb(l, f.attr(), f.css()), n = !0), l = l
												.first();
			...
			split : function(a, c) {
				for (var b = this.range, d = b.doc, e = b.cloneRange()
						.collapse(a), k = e.startContainer, f = e.startOffset, h = k.nodeType == 3
						? k.parentNode
						: k, l = !1, n; h && h.parentNode;) {
					n = i(h);
					if (c) {
						if (!n.isStyle())
							break;
				...
				if (l)
					d = d.createElement("span"), b.cloneRange().collapse(!a)
							...
							.setEnd(k, f) : e.setStart(k, f)
							.setEndAfter(h.lastChild), k = e.extractContents(), f = k.firstChild, l = k.lastChild, a
							? (e.insertNode(k), b.setStartAfter(l)
									.setEndBefore(d))
							: (h.appendChild(k), b.setStartBefore(d)
									.setEndBefore(f)), e = d.parentNode, e == b.endContainer
							&& (h = i(d).prev(), k = i(d).next(), h && k
									&& h.type == 3 && k.type == 3 ? b.setEnd(
									h[0], h[0].nodeValue.length) : a
									|| b
			...
			remove : function(a) {
				...
				b.enlarge();
				if (b.startOffset === 0) {
					for (var d = i(b.startContainer), e; (e = d.parent())
							&& e.isStyle() && e.children().length == 1;)
						d = e;
					b.setStart(d[0], 0);
				...
				if (d > 0) {
					...
					m
							&& pa(m)
							&& (m.remove(), b.setStart(c, d - 1), c == e
									&& b.setEnd(e, o - 1));
					if ((d = i(c.childNodes[d])) && pa(d))
						d.remove(), c == e && b.setEnd(e, o - 1)
				}
			...
			commonNode : function(a) {
				...
				var b = this.range, d = b.endContainer, b = b.endOffset, e = d.nodeType == 3
						|| b === 0 ? d : d.childNodes[b - 1], k = c(e);
				if (k)
					return k;
			...
			commonAncestor : function(a) {
				...
				var b = this.range, d = b.startContainer, e = b.startOffset, k = b.endContainer, b = b.endOffset, k = k.nodeType == 3
						|| b === 0 ? k : k.childNodes[b - 1], d = c(d.nodeType == 3
						|| e === 0 ? d : d.childNodes[e - 1]), e = c(k);
				if (d && e && d === e)
					return i(d);
				return null
			},
			...
			val : function(a) {
				var c = this.doc, a = a.toLowerCase(), b = "";
				if (a === "fontfamily" || a === "fontname")
					return b = pb(c, "fontname"), b = b.replace(/['"]/g, ""), b
							.toLowerCase();
				if (a === "formatblock") {
					b = pb(c, a);
				...
				if (a === "forecolor")
					return (a = this.commonNode({
								"*" : ".color"
							})) && (b = a.css("color")), b = r(b), b === ""
							&& (b = "default"), b.toLowerCase();
				if (a === "hilitecolor")
					return (a = this.commonNode({
								"*" : ".background-color"
							})) && (b = a.css("background-color")), b = r(b), b === ""
							&& (b = "default"), b.toLowerCase();
				return b
			},
			toggle : function(a, c) {
			...
			forecolor : function(a) {
				return this.wrap('<span style="color:' + a + ';"></span>')
						.select()
			},
			hilitecolor : function(a) {
				return this.wrap('<span style="background-color:' + a
						+ ';"></span>').select()
			},
			fontsize : function(a) {
				return this.wrap('<span style="font-size:' + a + ';"></span>')
						.select()
			},
			fontname : function(a) {
			...
			fontfamily : function(a) {
				return this
						.wrap('<span style="font-family:' + a + ';"></span>')
						.select()
			},
			...
			createlink : function(a, c) {
				...
				c && (k += ' target="' + s(c) + '"');
				if (e.collapsed)
					return k += ">" + s(a) + "</a>", this.inserthtml(k);
				if (e.isControl()) {
				...
				if (k.nodeType == 1
						&& k === h
						&& f + 1 === e
						&& (e = k.childNodes[f], e.nodeName.toLowerCase() == "a"))
					return b(e, a, c), this;
			...
			unlink : function() {
				...
				if (c.collapsed) {
					...
					ea(a, "unlink", null);
					ka
							&& i(c.startContainer).name === "img"
							&& (a = i(c.startContainer).parent(), a.name === "a"
									&& a.remove(!0))
				} else
					ea(a, "unlink", null);
				return this
		...
		A(ga, {
			...
			pos : function(a, c, b) {
				b = q(b, !0);
				if (a !== null
						&& (a = a < 0 ? 0 : o(a), this.div.css("left", a), b))
					this.x = a;
				if (c !== null
						&& (c = c < 0 ? 0 : o(c), this.div.css("top", c), b))
					this.y = c;
				return this
			},
			autoPos : function(a, c) {
				...
				if (this._alignEl) {
					var k = i(this._alignEl), f = k.pos(), b = fa(k[0].clientWidth
							/ 2 - b / 2), d = fa(k[0].clientHeight / 2 - d / 2);
					x = b < 0 ? f.x : f.x + b;
					y = d < 0 ? f.y : f.y + d
				} else
					f = X(this.doc), x = fa(e.x + (f.clientWidth - b) / 2), y = fa(e.y
							+ (f.clientHeight - d) / 2);
		...
		A(xa, ga, {
			init : function(a) {
				function c() {
					...
					ka && i(c).click(function(a) {
						i(a.target).name === "img"
								&& (l.selection(!0), l.range
										.selectNode(a.target), l.select())
					});
					if (F)
							...
							a.isControl() && b.blur()
								...
								.keydown(function(a) {
									if (a.which == 8) {
										...
										var c = l.range;
										c.isControl()
												&& (c.collapse(!0), i(c.startContainer.childNodes[c.startOffset])
														.remove(), a
														.preventDefault())
									}
								});
					...
					F
							? (c.body.disabled = !0, c.body.contentEditable = !0, c.body
				...
				var d = q(a.themesPath, ""), e = a.bodyClass, k = a.cssPath, f = a.cssData, h = location.protocol != "res:"
						&& location.host.replace(/:\d+/, "") !== document.domain, l = "document.open();"
						+ (h
						...
						: "";
				b.iframe = i('<iframe class="ke-edit-iframe" hidefocus="true" frameborder="0"'
						+ l + "></iframe>").css("width", "100%");
				b.textarea = i('<textarea class="ke-edit-textarea" hidefocus="true"></textarea>')
						.css("width", "100%");
				b.tabIndex = isNaN(parseInt(a.tabIndex, 10)) ? b.srcElement
						.attr("tabindex") : parseInt(a.tabIndex, 10);
			...
			html : function(a, c) {
				...
				if (this.designMode) {
					...
					if (a === d)
						return a = c
								? "<!doctype html><html>"
										+ b.parentNode.innerHTML + "</html>"
								: b.innerHTML, this.beforeGetHtml
								&& (a = this.beforeGetHtml(a)), la
								&& a == "<br />" && (a = ""), a;
					this.beforeSetHtml && (a = this.beforeSetHtml(a));
					F
							&& N >= 9
							&& (a = a.replace(/(<.*?checked=")checked(".*>)/ig,
									"$1$2"));
					i(b).html(a);
			...
			design : function(a) {
				if (a === d ? !this.designMode : a) {
					if (!this.designMode)
						a = this.html(), this.designMode = !0, this.html(a), this.textarea
								.hide(), this.iframe.show()
				} else if (this.designMode)
					a = this.html(), this.designMode = !1, this.html(a), this.iframe
							.hide(), this.textarea.show();
				return this.focus()
			},
			focus : function() {
		...
		A(Ga, ga, {
					init : function(a) {
						...
						function b(a, d) {
							var g = c(a.target);
							if (g && !g.hasClass("ke-disabled")
									&& !g.hasClass("ke-selected"))
								g[d]("ke-on")
						}
						var d = this;
						...
						d._itemMap = {};
						d.div.addClass("ke-toolbar").bind(
								"contextmenu,mousedown,mousemove", function(a) {
									a.preventDefault()
						...
						d.div.mouseover(function(a) {
							...
							var b = c(a.target);
							b
									&& !b.hasClass("ke-disabled")
									&& d.options.click.call(this, a, b
													.attr("data-name"))
						})
					},
					get : function(a) {
						...
						return this._itemMap[a] = i("span.ke-icon-" + a,
								this.div).parent()
					},
					select : function(a) {
					...
					disableAll : function(a, c) {
						...
						c && (e = z(c));
						(a === d ? !b.disableMode : a) ? (i("span.ke-outline",
								b.div).each(function() {
							var a = i(this), c = a[0].getAttribute("data-name",
									2);
							e[c] || b.disable(a)
						}), b.disableMode = !0) : (i("span.ke-outline", b.div)
								.each(function() {
									var a = i(this), c = a[0].getAttribute(
											"data-name", 2);
									e[c] || b.enable(a)
								}), b.disableMode = !1);
						return b
		...
		A(ya, ga, {
			...
			addItem : function(a) {
				if (a.title === "-")
					...
					var c = i('<div class="ke-menu-item" unselectable="on"></div>'), b = i('<div class="ke-inline-block ke-menu-item-left"></div>'), d = i('<div class="ke-inline-block ke-menu-item-right"></div>'), e = o(a.height), f = q(
							a.iconClass, "");
					this.div.append(c);
					e && (c.css("height", e), d.css("line-height", e));
					var h;
					this.centerLineMode
							&& (h = i('<div class="ke-inline-block ke-menu-item-center"></div>'), e
									&& h.css("height", e));
			...
			init : function(a) {
				...
				for (var e = 0; e < c.length; e++)
					for (var b = a.insertRow(e + 1), i = 0; i < c[e].length; i++)
						d = b.insertCell(i), this._addAttr(d, c[e][i],
								"ke-colorpicker-cell")
			},
			_addAttr : function(a, c, b) {
				var d = this, a = i(a).addClass(b);
				d.selectedColor === c.toLowerCase()
				...
				c
						? a
								.append(i('<div class="ke-colorpicker-cell-color" unselectable="on"></div>')
		...
		A(bb, {
			init : function(a) {
				var c = i(a.button), b = a.fieldName || "file", d = a.url || "", e = c
						.val(), f = a.extraParams || {}, h = c[0].className
						|| "", l = a.target || "kindeditor_upload_iframe_"
						+ (new Date).getTime();
				...
				var n = [], o;
				for (o in f)
					n.push('<input type="hidden" name="' + o + '" value="'
							+ f[o] + '" />');
				b = [
						'<div class="ke-inline-block ' + h + '">',
						a.target ? "" : '<iframe name="' + l
						...
						'<input type="file" class="ke-upload-file" name="' + b
								+ '" tabindex="-1" />',
						a.form ? "</div>" : "</form>", "</div>"].join("");
				b = i(b, c.doc);
				c.hide();
				c.before(b);
				this.div = b;
				this.button = c;
				this.iframe = a.target ? i('iframe[name="' + l + '"]') : i(
						"iframe", b);
			...
			submit : function() {
				...
				c.bind("load", function() {
					...
					b.reset();
					i(b).remove(!0);
					var b = i.iframeDoc(c), d = b.getElementsByTagName("pre")[0], e = "", f, e = d
							? d.innerHTML
							: b.body.innerHTML, e = v(e);
		...
		A(Aa, ga, {
			init : function(a) {
				...
				var b = a.title, d = i(a.body, this.doc), e = a.previewBtn, f = a.yesBtn, n = a.noBtn, o = a.closeBtn, m = q(
						a.showMask, !0);
				this.div.addClass("ke-dialog").bind("click,mousedown",
						function(a) {
							a.stopPropagation()
						});
				var s = i('<div class="ke-dialog-content"></div>')
						.appendTo(this.div);
				F && N < 7
						? this.iframeMask = i('<iframe src="about:blank" class="ke-dialog-shadow"></iframe>')
								.appendTo(this.div)
						: c
								&& i('<div class="ke-dialog-shadow"></div>')
										.appendTo(this.div);
				c = i('<div class="ke-dialog-header"></div>');
				s.append(c);
				c.html(b);
				this.closeIcon = i('<span class="ke-dialog-icon-close" title="'
						+ o.name + '"></span>').click(o.click);
				...
				h(		[{
							...
							if (this.btn) {
								var a = this.btn, a = a || {}, c = a.name || "", b = i('<span class="ke-button-common ke-button-outer" title="'
										+ c + '"></span>'), c = i('<input class="ke-button-common ke-button" type="button" value="'
										+ c + '" />');
			...
			showLoading : function(a) {
				var a = q(a, ""), c = this.bodyDiv;
				this.loading = i('<div class="ke-dialog-loading"><div class="ke-inline-block ke-dialog-loading-content" style="margin-top:'
		...
		i.tabs = function(a) {
			...
			c.select = function(a) {
				...
				h(e, function(b, d) {
							d.unbind();
							b === a ? (d.addClass("ke-tabs-li-selected"), i(d
									.data("tab").panel).show("")) : (d
		...
		i.ajax = function(a, c, d, e, i) {
			var d = d || "GET", i = i || "json", f = b.XMLHttpRequest
		...
		Ba.prototype = {
			...
			updateState : function() {
				...
				h(
						"justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,subscript,superscript,bold,italic,underline,strikethrough"
								.split(","), function(c, b) {
							a.cmd.state(b) ? a.toolbar.select(b) : a.toolbar
									.unselect(b)
						});
				return a
			},
			...
			create : function() {
				...
				var e = d ? X().clientWidth + "px" : c.width, f = d
						? X().clientHeight + "px"
						: c.height;
				if (F && N < 8 || da)
					f = o(l(f) + 2);
				...
				var h = i(".toolbar", k), n = i(".edit", k), m = c.statusbar = i(
						".statusbar", k);
				k.removeClass("container")
						.addClass("ke-container ke-container-" + c.themeType)
						.css("width", e);
				if (d) {
					k.css({
								position : "absolute",
					...
					c._fullscreenExecuted
							&& (i(document.body).css({
										height : "",
										overflow : ""
									}), i(document.body.parentNode).css(
									"overflow", "")), c._scrollPos
				...
				var h = c.toolbar = wb({
					...
					beforeGetHtml : function(a) {
						a = c.beforeGetHtml(a);
						a = ha(Ia(a));
						return H(a, c.filterMode ? c.htmlTags : null,
								c.urlType, c.wellFormatMode, c.indentChar)
					},
					beforeSetHtml : function(a) {
					...
					afterCreate : function() {
						...
						if (c._undoStack.length > 0) {
							...
							a.start
									&& (c.html(a.html), r.cmd.range
											.moveToBookmark(a), c.select())
						}
						c.afterCreate();
				...
				if (c._fullscreenResizeHandler)
					i(b).unbind("resize", c._fullscreenResizeHandler), c._fullscreenResizeHandler = null;
				a();
				d
						? (c._fullscreenResizeHandler = function() {
							c.isCreated
									&& c.resize(X().clientWidth,
											X().clientHeight, !1)
						}, i(b).bind("resize", c._fullscreenResizeHandler), h
								.select("fullscreen"), m.first().css(
								"visibility", "hidden"), m.last().css(
								"visibility", "hidden"))
						: (la && i(b).bind("scroll", function() {
									c._scrollPos = na()
								}), c.resizeType > 0 ? Xa({
									moveEl : k,
									clickEl : m,
								...
								}) : m.first().css("visibility", "hidden"), c.resizeType === 2
								? Xa({
											moveEl : k,
											clickEl : m.last(),
											moveFn : function(a, b, d, g, e, f) {
			...
			resize : function(a, c, b) {
				...
				if (a
						&& (/%/.test(a)
								|| (a = l(a), a = a < this.minWidth
										? this.minWidth
										: a), this.container.css("width", o(a)), b))
					this.width = o(a);
				if (c
						&& (c = l(c), editHeight = l(c)
								- this.toolbar.div.height()
								- this.statusbar.height(), editHeight = editHeight < this.minHeight
								? this.minHeight
								: editHeight, this.edit.setHeight(editHeight), b))
					this.height = o(c);
				return this
			},
			select : function() {
			...
			count : function(a) {
				...
				if (a === "text")
					return this.text().replace(/<(?:img|embed).*?>/ig, "K")
							.replace(/\r\n|\n|\r/g, "").length;
				return 0
			},
			exec : function(a) {
				var a = a.toLowerCase(), c = this.cmd, b = e(a,
						"selectall,copy,paste,print".split(",")) < 0;
				b && this.addBookmark(!1);
				c[a].apply(c, D(arguments, 1));
				b
						&& (this.updateState(), this.addBookmark(!1), this.options.afterChange
			...
			appendHtml : function(a) {
				...
				if (this.isCreated)
					a = this.cmd, a.range.selectNodeContents(a.doc.body)
							.collapse(!1), a.select();
				return this
			},
			sync : function() {
			...
			addBookmark : function(a) {
				...
				if (a
						...
						&& Math
								.abs(d.length
										- ha(this._undoStack[this._undoStack.length
												- 1].html).length) < this.minChangeSize)
					return this;
				c.designMode && !this._firstAddBookmark
						? (c = this.cmd.range, a = c.createBookmark(!0), a.html = Ia(b.innerHTML), c
								.moveToBookmark(a))
						: a = {
							html : d
						};
			...
			readonly : function(a) {
				...
				c.designMode ? c.toolbar.disableAll(a, []) : h(
						c.noDisableItems, function() {
							c.toolbar[a ? "disable" : "enable"](this)
						});
				F ? d.body.contentEditable = !a : d.designMode = a
						? "off"
						: "on";
			...
			createMenu : function(a) {
				...
				a.selectedColor !== d
						? (a.cls = "ke-colorpicker-" + this.themeType, a.noColor = this
								.lang("noColor"), this.menu = xb(a))
						: (a.cls = "ke-menu-" + this.themeType, a.centerLineMode = !1, this.menu = ab(a));
				return this.menu
			},
			hideMenu : function() {
				this.menu.remove();
			...
			hideDialog : function() {
				...
				this.dialogs.length > 0
						&& this.dialogs[0]
								.setMaskIndex(this.dialogs[this.dialogs.length
										- 1].z
										- 1);
				return this
			},
		...
		Ab("core", function(a) {
			...
			c.afterCreate(function() {
						if (c.syncType == "form") {
							for (var d = a(c.srcElement), g = !1; d = d
									.parent();)
								if (d.name == "form") {
									g = !0;
									break
			...
			c.clickToolbar("source", function() {
						c.edit.designMode
								? (c.toolbar.disableAll(!0), c.edit.design(!1), c.toolbar
										.select("source"))
								: (c.toolbar.disableAll(!1), c.edit.design(!0), c.toolbar
										.unselect("source"), la ? setTimeout(
										function() {
											c.cmd.selection()
										}, 0) : c.cmd.selection());
			...
			c.afterCreate(function() {
						c.designMode
								|| c.toolbar.disableAll(!0).select("source")
					});
			...
			c.clickToolbar("fontname", function() {
						var a = c.cmd.val("fontname"), b = c.createMenu({
									name : "fontname",
									width : 150
								});
			...
			c.clickToolbar("fontsize", function() {
						var a = c.cmd.val("fontsize"), b = c.createMenu({
									name : "fontsize",
									width : 150
								});
			...
			h(
					"prop,cellprop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,rowmerge,colmerge,rowsplit,colsplit,coldelete,rowdelete,insert,delete"
							.split(","), function(a, b) {
						var d = e(b, ["prop", "delete"]) < 0
								? c.plugin.getSelectedCell
			...
			c.afterCreate(function() {
				function b() {
					...
					g.select();
					ka
							&& (a("div." + i, f).each(function() {
										a(this).after("<br />").remove(!0)
									}), a("span.Apple-style-span", f)
									.remove(!0), a("span.Apple-tab-span", f)
									.remove(!0), a("span[style]", f).each(
									function() {
										a(this).css("white-space") == "nowrap"
												&& a(this).remove(!0)
									}), a("meta", f).remove());
					var d = f[0].innerHTML;
					f.remove();
					d !== ""
							&& (ka && (d = d.replace(/(<br>)\1/ig, "$1")), c.pasteType === 2
									&& (d = d
											.replace(
													/(<(?:p|p\s[^>]*)>) *(<\/p>)/ig,
													""), /schemas-microsoft-com|worddocument|mso-\w+/i
											.test(d)
											? d = U(
													d,
													c.filterMode
											...
											: (d = H(d, c.filterMode
															? c.htmlTags
															: null), d = c
													.beforeSetHtml(d))), c.pasteType === 1
									&& (d = d.replace(/&nbsp;/ig, " "), d = d
											.replace(/\n\s*\n/g, "\n"), d = d
											.replace(/<br[^>]*>/ig, "\n"), d = d
											.replace(/<\/p><p[^>]*>/ig, "\n"), d = d
											.replace(/<[^>]+>/g, ""), d = d
											.replace(/ {2}/g, " &nbsp;"), c.newlineTag == "p"
											? /\n/.test(d)
													&& (d = d
															.replace(/^/, "<p>")
															.replace(/$/,
				...
				a(d.body).bind("paste", function(l) {
							if (c.pasteType === 0)
								...
								if (F) {
									...
									g.range.selectNodeContents(f[0]), g
											.select();
								setTimeout(function() {
											b();
											h = !1
			...
			c.beforeGetHtml(function(a) {
				...
				return a
						...
						.replace(
								...
								function(a) {
									var a = K(a), b = M(a.style || ""), c = S(a["data-ke-tag"]), d = q(
											b.width, ""), b = q(b.height, "");
									/px/i.test(d) && (d = l(d));
									/px/i.test(b) && (b = l(b));
									c.width = q(a.width, d);
			...
			var j = [
					...
					.join(""), j = d.createDialog({
						...
						yesBtn : {
							name : d.lang("yes"),
							click : function() {
								d.insertHtml('<a name="' + e.val() + '">')
										.hideDialog().focus()
							}
						}
					}).div, e = b('input[name="name"]', j);
			(j = d.plugin.getSelectedAnchor())
					&& e.val(unescape(j.attr("data-ke-name")));
			e[0].focus();
			e[0].select()
		},
		"delete" : function() {
...
KindEditor.plugin("autoheight", function(b) {
			function d() {
				...
				d.iframe.height(e);
				j.resize(null, Math.max(
								(b.IE ? f.scrollHeight : f.offsetHeight) + 76,
								e))
			}
			function f() {
...
KindEditor.plugin("baidumap", function(b) {
	var d = this, f = d.lang("baidumap."), j = b.undef(d.mapWidth, 558), e = b
			.undef(d.mapHeight, 360);
	d.clickToolbar("baidumap", function() {
		...
		var m = [
				...
				'<div class="ke-map" style="width:' + j + "px;height:" + e
						+ 'px;"></div>', "</div>"].join(""), m = d
				.createDialog({
					name : "baidumap",
					width : j + 42,
					...
					yesBtn : {
						name : d.lang("yes"),
						click : function() {
							var b = v.map, f = b.getCenter(), f = f.lng + ","
									+ f.lat, b = b.getZoom(), b = [
									s[0].checked
											? d.pluginsPath
													+ "baidumap/index.html"
											: "http://api.map.baidu.com/staticimage",
									"?center=" + encodeURIComponent(f),
									"&zoom=" + encodeURIComponent(b),
									"&width=" + j,
									"&height=" + e,
									"&markers=" + encodeURIComponent(f),
									"&markerStyles="
											+ encodeURIComponent("l,A")]
									.join("");
							s[0].checked ? d.insertHtml('<iframe src="' + b
									+ '" frameborder="0" style="width:'
									+ (j + 2) + "px;height:" + (e + 2)
									+ 'px;"></iframe>') : d.exec("insertimage",
									b);
							d.hideDialog().focus()
						}
					},
				...
				}), n = m.div, o = b('[name="address"]', n), l = b(
				'[name="searchBtn"]', n), s = b('[name="insertDynamicMap"]',
				m.div), v, p, r = b('<iframe class="ke-textarea" frameborder="0" src="'
				+ d.pluginsPath
...
KindEditor.plugin("clearhtml", function(b) {
	...
	d.clickToolbar("clearhtml", function() {
		...
		var f = d.html(), f = f.replace(
				...
				/(<style[^>]*>)([\s\S]*?)(<\/style>)/ig, ""), f = b.formatHtml(
				f, {
					a : ["href", "target"],
	...
	d.clickToolbar("code", function() {
		var f = d.lang("code."), j = d.createDialog({
			...
			yesBtn : {
				name : d.lang("yes"),
				click : function() {
					var h = b(".ke-code-type", j.div).val(), m = e.val(), h = '<pre class="prettyprint'
							+ (h === "" ? "" : " lang-" + h)
							+ '">\n'
							+ b.escape(m) + "</pre> ";
					b.trim(m) === "" ? (alert(f.pleaseInput), e[0].focus()) : d
							.insertHtml(h).hideDialog().focus()
				}
			}
		}), e = b("textarea", j.div);
		e[0].focus()
...
KindEditor.plugin("emoticons", function(b) {
	var d = this, f = d.emoticonsPath || d.pluginsPath + "emoticons/images/", j = d.allowPreviewEmoticons === void 0
			? !0
			: d.allowPreviewEmoticons, e = 1;
	d.clickToolbar("emoticons", function() {
		function h(e, h, l) {
			B ? e.mouseover(function() {
						h > D ? (B.css("left", 0), B.css("right", "")) : (B
								.css("left", ""), B.css("right", 0));
						G.attr("src", f + l + ".gif");
		...
		function m(d, e) {
			...
			for (var n = (d - 1) * r + p, o = 0; o < s; o++)
				for (var m = l.insertRow(o), j = 0; j < v; j++) {
					...
					q.addClass("ke-cell");
					h(q, j, n);
					var u = b('<span class="ke-img"></span>')
							.css("background-position", "-" + 24 * n + "px 0px")
							.css("background-image", "url(" + f + "static.gif)");
					q.append(u);
					A.push(q);
					n++
				}
		...
		var s = 5, v = 9, p = 0, r = s * v, z = Math.ceil(135 / r), D = Math
				.floor(v / 2), q = b('<div class="ke-plugin-emoticons"></div>'), A = [];
		d.createMenu({
					name : "emoticons",
					beforeRemove : function() {
						n()
		...
		var B, G;
		j
				&& (B = b('<div class="ke-preview"></div>').css("right", 0), G = b('<img class="ke-preview-img" src="'
						+ f + p + '.gif" />'), q.append(B), B.append(G));
		var C = m(e, q), u;
		l(e)
	})
});
KindEditor.plugin("filemanager", function(b) {
	...
	var f = this, j = b.undef(f.fileManagerJson, f.basePath
					+ "php/file_manager_json.php"), e = f.pluginsPath
			+ "filemanager/images/", h = f.lang("filemanager.");
	f.plugin.filemanagerDialog = function(m) {
		...
		function o(d, e, f, h) {
			var l = b.formatUrl(e.current_url + f.filename, "absolute"), o = encodeURIComponent(e.current_dir_path
					+ f.filename + "/");
		...
		function l(d, e) {
			function f() {
				C.val() == "VIEW" ? n(d.current_dir_path, u.val(), v) : n(
						d.current_dir_path, u.val(), s)
			}
			b.each(I, function() {
						this.unbind()
					});
		...
		function s(d) {
			...
			for (var n = d.file_list, m = 0, j = n.length; m < j; m++) {
				...
				var q = b('<img src="'
						+ (e + (r.is_dir ? "folder-16.gif" : "file-16.gif"))
						+ '" width="16" height="16" alt="' + r.filename
						+ '" align="absmiddle" />'), q = b(p[0].insertCell(0))
						.addClass("ke-cell ke-name").append(q).append(document
								.createTextNode(" " + r.filename));
				!r.is_dir || r.has_file ? (p.css("cursor", "pointer"), q.attr(
						"title", r.filename), o(q, d, r, s)) : q.attr("title",
						h.emptyFolder);
				b(p[0].insertCell(1)).addClass("ke-cell ke-size").html(r.is_dir
						? "-"
						: Math.ceil(r.filesize / 1024) + "KB");
				b(p[0].insertCell(2)).addClass("ke-cell ke-datetime")
						.html(r.datetime)
			}
		}
		function v(f) {
			...
			for (var n = f.file_list, m = 0, s = n.length; m < s; m++) {
				...
				r.append(p);
				var q = f.current_url + j.filename, q = b('<img src="'
						+ (j.is_dir ? e + "folder-64.gif" : j.is_photo ? q : e
								+ "file-64.gif")
						+ '" width="80" height="80" alt="' + j.filename
						+ '" />');
				!j.is_dir || j.has_file
						? (p.css("cursor", "pointer"), d(p, j), o(p, f, j, v))
		...
		var p = b.undef(m.width, 650), r = b.undef(m.height, 510), z = b.undef(
				m.dirName, ""), D = b.undef(m.viewType, "VIEW").toUpperCase(), q = m.clickFn, m = [
				'<div style="padding:10px 20px;"><div class="ke-plugin-filemanager-header"><div class="ke-left">',
				...
				'</select></div><div class="ke-clearfix"></div></div><div class="ke-plugin-filemanager-body"></div></div>']
				.join(""), A = f.createDialog({
					name : "filemanager",
					width : p,
					height : r,
...
KindEditor.plugin("flash", function(b) {
	var d = this, f = d.lang("flash."), j = b.undef(d.allowFlashUpload, !0), e = b
			.undef(d.allowFileManager, !1), h = b.undef(d.formatUploadUrl, !0), m = b
			.undef(d.extraFileUploadParams, {}), n = b.undef(d.filePostName,
			"imgFile"), o = b.undef(d.uploadJson, d.basePath
					+ "php/upload_json.php");
	d.plugin.flash = {
		edit : function() {
			var l = [
					'<div style="padding:20px;"><div class="ke-dialog-row">',
					'<label for="keUrl" style="width:60px;">' + f.url
							+ "</label>",
					...
					'<label for="keWidth" style="width:60px;">' + f.width
							+ "</label>",
					...
					'<label for="keHeight" style="width:60px;">' + f.height
							+ "</label>",
					'<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="400" maxlength="4" /> </div></div>']
					.join(""), s = d.createDialog({
						name : "flash",
						width : 450,
						title : d.lang("flash"),
						body : l,
						yesBtn : {
							name : d.lang("yes"),
							click : function() {
								var e = b.trim(p.val()), f = r.val(), h = z
										.val();
								e == "http://" || b.invalidUrl(e)
										? (alert(d.lang("invalidUrl")), p[0]
												.focus())
										: /^\d*$/.test(f)
												? /^\d*$/.test(h)
														? (e = b
																...
																.focus())
														: (alert(d
																.lang("invalidHeight")), z[0]
																.focus())
												: (alert(d.lang("invalidWidth")), r[0]
														.focus())
							}
						}
					}), v = s.div, p = b('[name="url"]', v), l = b(
					'[name="viewServer"]', v), r = b('[name="width"]', v), z = b(
					'[name="height"]', v);
			p.val("http://");
			if (j) {
			...
			e ? l.click(function() {
				d.loadPlugin("filemanager", function() {
					d.plugin.filemanagerDialog({
						...
						clickFn : function(e) {
							d.dialogs.length > 1
									&& (b('[name="url"]', v).val(e), d.afterSelectFile
											&& d.afterSelectFile.call(d, e), d
											.hideDialog())
						}
					})
				})
...
KindEditor.plugin("image", function(b) {
	var d = this, f = b.undef(d.allowImageUpload, !0), j = b.undef(
			d.allowImageRemote, !0), e = b.undef(d.formatUploadUrl, !0), h = b
			.undef(d.allowFileManager, !1), m = b.undef(d.uploadJson,
			d.basePath + "php/upload_json.php"), n = b
			.undef(d.imageTabIndex, 0), o = d.pluginsPath + "image/images/", l = b
			.undef(d.extraFileUploadParams, {}), s = b.undef(d.filePostName,
			"imgFile"), v = b.undef(d.fillDescAfterUploadImage, !1), p = d
			.lang("image.");
	d.plugin.imageDialog = function(f) {
		...
		var j = b.undef(f.showRemote, !0), q = b.undef(f.showLocal, !0), A = b
				.undef(f.tabIndex, 0), B = f.clickFn, G = "kindeditor_upload_iframe_"
				+ (new Date).getTime(), C = [], u;
		for (u in l)
			C.push('<input type="hidden" name="' + u + '" value="' + l[u]
					+ '" />');
		var C = [
				'<div style="padding:20px;"><div class="tabs"></div><div class="tab1" style="display:none;"><div class="ke-dialog-row">',
				'<label for="remoteUrl" style="width:60px;">' + p.remoteUrl
						+ "</label>",
				...
				'<input type="radio" name="align" class="ke-inline-block" value="" checked="checked" /> <img name="defaultImg" src="'
						+ o + 'align_top.gif" width="23" height="25" alt="" />',
				...
				'<iframe name="' + G + '" style="display:none;"></iframe>',
				'<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="'
						+ G + '" action="' + b.addParam(m, "dir=image") + '">',
				'<div class="ke-dialog-row">',
				C.join(""),
				'<label style="width:60px;">' + p.localUrl + "</label>",
				'<input type="text" name="localUrl" class="ke-input-text" tabindex="-1" style="width:200px;" readonly="true" /> &nbsp;',
				'<input type="button" class="ke-upload-button" value="'
						+ p.upload + '" />', "</div></form></div></div>"]
				.join(""), I = d.createDialog({
			name : "image",
			width : q || h ? 450 : 400,
			height : q && j ? 300 : 250,
			title : d.lang("image"),
				...
				click : function() {
					if (!I.isLoading)
						if (q && j && H && H.selectedIndex === 1 || !j)
							U.fileBox.val() == "" ? alert(d
									.lang("pleaseSelectFile")) : (I
									.showLoading(d.lang("uploadLoading")), U
									.submit(), qa.val(""));
						else {
							var e = b.trim(T.val()), f = M.val(), h = K.val(), l = Q
									.val(), n = "";
							R.each(function() {
										if (this.checked)
											return n = this.value, !1
									});
							e == "http://" || b.invalidUrl(e)
									? (alert(d.lang("invalidUrl")), T[0]
											.focus())
									: /^\d*$/.test(f)
											? /^\d*$/.test(h)
													? B.call(d, e, l, f, h, 0,
															n)
													: (alert(d
															.lang("invalidHeight")), K[0]
															.focus())
											: (alert(d.lang("invalidWidth")), M[0]
													.focus())
						}
				}
			},
		...
		}), E = I.div, T = b('[name="url"]', E), qa = b('[name="localUrl"]', E), $ = b(
				'[name="viewServer"]', E), M = b('.tab1 [name="width"]', E), K = b(
				'.tab1 [name="height"]', E), O = b(".ke-refresh-btn", E), Q = b(
				'.tab1 [name="title"]', E), R = b('.tab1 [name="align"]', E), H;
		j && q ? (H = b.tabs({
					src : b(".tabs", E),
		...
		var U = b.uploadbutton({
					...
					afterUpload : function(f) {
						...
						if (f.error === 0) {
							...
							d.afterUpload
									&& d.afterUpload.call(d, h, f, "image");
							v ? (b(".ke-dialog-row #remoteUrl", E).val(h), b(
									".ke-tabs-li", E)[0].click(), b(
									".ke-refresh-btn", E).click()) : B.call(d,
									h, f.title, f.width, f.height, f.border,
									f.align)
						} else
							alert(f.message)
					},
		...
		h ? $.click(function() {
			d.loadPlugin("filemanager", function() {
				d.plugin.filemanagerDialog({
					...
					clickFn : function(e) {
						d.dialogs.length > 1
								&& (b('[name="url"]', E).val(e), d.afterSelectFile
										&& d.afterSelectFile.call(d, e), d
										.hideDialog())
					}
				})
		...
		M.change(function() {
					W > 0
							&& K.val(Math.round(S / W
									* parseInt(this.value, 10)))
				});
		K.change(function() {
					S > 0
							&& M.val(Math.round(W / S
									* parseInt(this.value, 10)))
				});
		T.val(f.imageUrl);
		...
		edit : function() {
			...
			d.plugin.imageDialog({
						...
						clickFn : function(e, f, h, l, n, o) {
							b ? (b.attr("src", e), b.attr("data-ke-src", e), b
									.attr("width", h), b.attr("height", l), b
									.attr("title", f), b.attr("align", o), b
									.attr("alt", f)) : d.exec("insertimage", e,
									f, h, l, n, o);
							setTimeout(function() {
										d.hideDialog().focus()
									}, 0)
...
KindEditor.plugin("insertfile", function(b) {
	var d = this, f = b.undef(d.allowFileUpload, !0), j = b.undef(
			d.allowFileManager, !1), e = b.undef(d.formatUploadUrl, !0), h = b
			.undef(d.uploadJson, d.basePath + "php/upload_json.php"), m = b
			.undef(d.extraFileUploadParams, {}), n = b.undef(d.filePostName,
			"imgFile"), o = d.lang("insertfile.");
	d.plugin.fileDialog = function(l) {
		var s = b.undef(l.fileUrl, "http://"), v = b.undef(l.fileTitle, ""), p = l.clickFn, l = [
				'<div style="padding:20px;"><div class="ke-dialog-row">',
				'<label for="keUrl" style="width:60px;">' + o.url + "</label>",
				...
				'<input type="button" class="ke-button-common ke-button" name="viewServer" value="'
						+ o.viewServer + '" />',
				'</span></div><div class="ke-dialog-row">',
				'<label for="keTitle" style="width:60px;">' + o.title
						+ "</label>",
				'<input type="text" id="keTitle" class="ke-input-text" name="title" value="" style="width:160px;" /></div></div></form></div>']
				.join(""), r = d.createDialog({
					name : "insertfile",
					width : 450,
					...
					yesBtn : {
						...
						click : function() {
							...
							e == "http://" || b.invalidUrl(e) ? (alert(d
									.lang("invalidUrl")), D[0].focus()) : (b
									.trim(f) === ""
									&& (f = e), p.call(d, e, f))
						}
					}
				}), z = r.div, D = b('[name="url"]', z), l = b(
				'[name="viewServer"]', z), q = b('[name="title"]', z);
		if (f) {
		...
		j ? l.click(function() {
			d.loadPlugin("filemanager", function() {
				d.plugin.filemanagerDialog({
					...
					clickFn : function(e) {
						d.dialogs.length > 1
								&& (b('[name="url"]', z).val(e), d.afterSelectFile
										&& d.afterSelectFile.call(d, e), d
										.hideDialog())
					}
				})
...
KindEditor.plugin("link", function(b) {
	...
	d.plugin.link = {
		edit : function() {
			var f = d.lang("link."), j = '<div style="padding:20px;"><div class="ke-dialog-row"><label for="keUrl" style="width:60px;">'
					+ f.url
					...
					+ f.linkType
					+ '</label><select id="keType" name="type"></select></div></div>', j = d
					.createDialog({
								name : "link",
								width : 450,
								title : d.lang("link"),
			...
			if (f = d.plugin.getSelectedLink())
				d.cmd.range.selectNode(f[0]), d.cmd.select(), e.val(f
						.attr("data-ke-src")), h.val(f.attr("target"));
			e[0].focus();
			e[0].select()
		},
		"delete" : function() {
...
KindEditor.plugin("map", function(b) {
	...
	d.clickToolbar("map", function() {
		...
		var e = [
				...
				'<input type="button" name="searchBtn" class="ke-button-common ke-button" value="'
						+ f.search + '" />',
				'</span></div><div class="ke-map" style="width:558px;height:360px;"></div></div>']
				.join(""), e = d.createDialog({
			name : "map",
			width : 600,
			title : d.lang("map"),
			body : e,
			yesBtn : {
				name : d.lang("yes"),
				click : function() {
					var b = n.map, e = b.getCenter().lat() + ","
							+ b.getCenter().lng(), f = b.getZoom(), b = b
							.getMapTypeId(), h = "http://maps.googleapis.com/maps/api/staticmap";
		...
		[
				...
				.join("\n");
		var l = b('<iframe class="ke-textarea" frameborder="0" src="'
				+ d.pluginsPath
...
KindEditor.plugin("media", function(b) {
	var d = this, f = d.lang("media."), j = b.undef(d.allowMediaUpload, !0), e = b
			.undef(d.allowFileManager, !1), h = b.undef(d.formatUploadUrl, !0), m = b
			.undef(d.extraFileUploadParams, {}), n = b.undef(d.filePostName,
			"imgFile"), o = b.undef(d.uploadJson, d.basePath
					+ "php/upload_json.php");
	d.plugin.media = {
		edit : function() {
			var l = [
					...
					'<label for="keAutostart">' + f.autostart + "</label>",
				...
				yesBtn : {
					...
					click : function() {
						...
						e == "http://" || b.invalidUrl(e) ? (alert(d
								.lang("invalidUrl")), p[0].focus()) : /^\d*$/
								.test(f) ? /^\d*$/.test(h) ? (e = b.mediaImg(
								d.themesPath + "common/blank.gif", {
									src : e,
									type : b.mediaType(e),
									width : f,
									height : h,
								...
								: (alert(d.lang("invalidHeight")), z[0].focus())
								: (alert(d.lang("invalidWidth")), r[0].focus())
					}
				}
			}), v = s.div, p = b('[name="url"]', v), l = b(
					'[name="viewServer"]', v), r = b('[name="width"]', v), z = b(
					'[name="height"]', v), D = b('[name="autostart"]', v);
			p.val("http://");
			if (j) {
	...
	b.extend(d, {
		init : function(d) {
			function j(d, e) {
				...
				b(".ke-message", d).addClass("ke-error").show().html(b
						.escape(e))
			}
			var e = this;
			...
			var h = {
				...
				upload_error_handler : function(d) {
					d
							&& d.filestatus == SWFUpload.FILE_STATUS.ERROR
							&& (d = b('div[data-id="' + d.id + '"]', e.bodyDiv)
									.eq(0), j(d, e.options.errorMessage))
				},
				upload_success_handler : function(d, f) {
					...
					l.error !== 0
							? j(h, b.DEBUG ? l.message : e.options.errorMessage)
							: (d.url = l.url, b(".ke-img", h)
									.attr("src", d.url).attr("data-status",
											d.filestatus).data("data", l), b(
									".ke-status > div", h).hide())
				}
			};
		...
		getUrlList : function() {
			...
			b(".ke-img", self.bodyDiv).each(function() {
				var j = b(this);
				j.attr("data-status") == SWFUpload.FILE_STATUS.COMPLETE
						&& d.push(j.data("data"))
			});
			return d
		},
		...
		appendFile : function(d) {
			var j = this, e = b('<div class="ke-inline-block ke-item" data-id="'
					+ d.id + '"></div>');
			j.bodyDiv.append(e);
			...
			b('<div class="ke-progressbar"><div class="ke-progressbar-bar"><div class="ke-progressbar-bar-inner"></div></div><div class="ke-progressbar-percent">0%</div></div>')
					.hide().appendTo(m);
			b('<div class="ke-message">' + j.options.pendingMessage + "</div>")
					.appendTo(m);
...
KindEditor.plugin("multiimage", function(b) {
	...
	var f = b.undef(d.uploadJson, d.basePath + "php/upload_json.php"), j = d.pluginsPath
			+ "multiimage/images/", e = b.undef(d.imageSizeLimit, "1MB");
	b.undef(d.imageFileTypes, "*.jpg;*.gif;*.png");
	var h = b.undef(d.imageUploadLimit, 20), m = b.undef(d.filePostName,
			"imgFile"), n = d.lang("multiimage.");
	d.plugin.multiImageDialog = function(o) {
		var l = o.clickFn, o = b.tmpl(n.uploadDesc, {
					uploadLimit : h,
					sizeLimit : e
				}), s = d.createDialog({
			name : "multiimage",
				...
				d.plugin.multiImageDialog({
							clickFn : function(e) {
								e.length !== 0 && (b.each(e, function(b, e) {
											d.afterUpload
													&& d.afterUpload.call(d,
															e.url, e,
															"multiimage");
											d.exec("insertimage", e.url,
...
(function() {
	...
	SWFUpload.prototype.initSWFUpload = function(b) {
		try {
			this.customSettings = {}, this.settings = b, this.eventQueue = [], this.movieName = "KindEditor_SWFUpload_"
					+ SWFUpload.movieCount++, this.movieElement = null, SWFUpload.instances[this.movieName] = this, this
					.initSettings(), this.loadFlash(), this.displayDebugInfo()
		} catch (d) {
	...
	SWFUpload.prototype.initSettings = function() {
		this.ensureDefault = function(b, d) {
			this.settings[b] = this.settings[b] == void 0
					? d
					: this.settings[b]
		};
		...
		if (!this.settings.preserve_relative_urls)
			this.settings.upload_url = SWFUpload
					.completeURL(this.settings.upload_url), this.settings.button_image_url = SWFUpload
	...
	SWFUpload.prototype.getFlashHTML = function() {
		...
		return [
				'<object id="',
				this.movieName,
				'"' + b + ' type="application/x-shockwave-flash" data="',
	...
	SWFUpload.prototype.getFlashVars = function() {
		var b = this.buildParamString(), d = this.settings.http_success
				.join(",");
	...
	SWFUpload.prototype.buildParamString = function() {
		...
		if (typeof b === "object")
			for (var f in b)
				b.hasOwnProperty(f)
						&& d.push(encodeURIComponent(f.toString()) + "="
								+ encodeURIComponent(b[f].toString()));
		return d.join("&amp;")
	};
	SWFUpload.prototype.destroy = function() {
		try {
			...
			var b = null;
			if ((b = this.getMovieElement())
					&& typeof b.CallFunction === "unknown") {
				for (var d in b)
					try {
	...
	SWFUpload.prototype.callFlash = function(b, d) {
		...
		try {
			e = f.CallFunction('<invoke name="' + b
					+ '" returntype="javascript">'
					+ __flash__argumentsToXML(d, 0) + "</invoke>"), j = eval(e)
		} catch (h) {
			throw "Call to " + b + " failed";
		}
		j != void 0 && typeof j.post === "object"
				&& (j = this.unescapeFilePostParams(j));
		return j
	};
	...
	SWFUpload.prototype.getFile = function(b) {
		return typeof b === "number"
				? this.callFlash("GetFileByIndex", [b])
	...
	SWFUpload.prototype.setButtonDimensions = function(b, d) {
		...
		if (f != void 0)
			f.style.width = b + "px", f.style.height = d + "px";
			...
			for (var e in b.post)
				if (b.post.hasOwnProperty(e)) {
					...
					for (var h; (h = d.exec(j)) !== null;)
						j = j.replace(h[0], String.fromCharCode(parseInt("0x"
												+ h[1], 16)));
					f[j] = b.post[e]
				}
			b.post = f
	...
	SWFUpload.prototype.returnUploadStart = function(b) {
		...
		if (typeof this.settings.upload_start_handler === "function")
			b = this.unescapeFilePostParams(b), d = this.settings.upload_start_handler
					.call(this, b);
	...
	SWFUpload.Console.writeLine = function(b) {
		...
		try {
			...
			if (!d)
				f = document.createElement("form"), document
						.getElementsByTagName("body")[0].appendChild(f), d = document
						.createElement("textarea"), d.id = "SWFUpload_Console", d.style.fontFamily = "monospace", d
						.setAttribute("wrap", "off"), d.wrap = "off", d.style.overflow = "auto", d.style.width = "700px", d.style.height = "350px", d.style.margin = "5px", f
						.appendChild(d);
			d.value += b + "\n";
...
(function() {
	if (typeof SWFUpload === "function")
		SWFUpload.queue = {}, SWFUpload.prototype.initSettings = function(b) {
			return function() {
		...
		}(SWFUpload.prototype.initSettings), SWFUpload.prototype.startUpload = function(
				b) {
			this.queueSettings.queue_cancelled_flag = !1;
			this.callFlash("StartUpload", [b])
			...
			typeof this.queueSettings.user_upload_start_handler === "function"
					&& (d = this.queueSettings.user_upload_start_handler.call(
							this, b));
			d = d === !1 ? !1 : !0;
			...
			if (typeof d === "function"
					? d.call(this, b) !== !1
					: b.filestatus !== SWFUpload.FILE_STATUS.QUEUED)
...
KindEditor.plugin("pagebreak", function(b) {
	var d = this, f = b.undef(d.pagebreakHtml,
	...
	d.clickToolbar("pagebreak", function() {
				...
				d.insertHtml(f + h);
				h !== ""
						&& (h = b("#__kindeditor_tail_tag__", d.edit.doc), e
								.selectNodeContents(h[0]), h.removeAttr("id"), j
								.select())
			})
});
KindEditor.plugin("plainpaste", function(b) {
	...
	d.clickToolbar("plainpaste", function() {
		var f = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">'
				+ d.lang("plainpaste.").comment
				+ '</div><textarea class="ke-textarea" style="width:408px;height:260px;"></textarea></div>', f = d
				.createDialog({
					name : "plainpaste",
					width : 450,
					...
					yesBtn : {
						name : d.lang("yes"),
						click : function() {
							var e = j.val(), e = b.escape(e), e = e.replace(
									/ {2}/g, " &nbsp;"), e = d.newlineTag == "p"
									? e.replace(/^/, "<p>")
											.replace(/$/, "</p>").replace(
													/\n/g, "</p><p>")
									: e.replace(/\n/g, "<br />$&");
...
KindEditor.plugin("quickformat", function(b) {
	...
	f.clickToolbar("quickformat", function() {
		f.focus();
		for (var e = f.edit.doc, h = f.cmd.range, m = b(e.body).first(), n, o = [], l = [], s = h
				.createBookmark(!0); m;) {
			n = m.next();
			var v = d(m);
			if (!v || v.name != "img")
				if (j[m.name] ? (m.html(m.html().replace(
						/^(\s|&nbsp;|\u3000)+/ig, "")), m.css("text-indent",
						"2em")) : l.push(m), !n || j[n.name] || j[m.name]
						&& !j[n.name])
					l.length > 0 && o.push(l), l = [];
			m = n
		}
	...
	e.plugin.table = {
		prop : function(n) {
			var o = [
					...
					.join(""), l = e.cmd.range.createBookmark(), o = e
					.createDialog({
						name : "table",
						width : 500,
						title : e.lang("table"),
						...
						yesBtn : {
							name : e.lang("yes"),
							click : function() {
								var d = j.val(), f = m.val(), h = p.val(), n = r
										.val(), o = z.val(), I = D.val(), O = q
										.val(), Q = A.val(), R = B.val(), H = G
										.val(), U = b(C[0]).html() || "", W = b(C[1])
										.html()
										|| "";
								if (d == 0 || !/^\d+$/.test(d))
									alert(e.lang("invalidRows")), j[0].focus();
								else if (f == 0 || !/^\d+$/.test(f))
									alert(e.lang("invalidRows")), m[0].focus();
								else if (/^\d*$/.test(h))
									if (/^\d*$/.test(n))
										if (/^\d*$/.test(O))
											if (/^\d*$/.test(Q))
												if (/^\d*$/.test(H)) {
													if (u)
														h !== "" ? u.width(h
																...
																.css(
																		"background-color",
																		W), u[0].bgColor !== void 0
																&& u
																		.removeAttr("bgColor"), O !== ""
																? u[0].cellPadding = O
																: u
																		.removeAttr("cellPadding"), Q !== ""
																? u[0].cellSpacing = Q
																: u
																		.removeAttr("cellSpacing"), R !== ""
																? u[0].align = R
																: u
																		.removeAttr("align"), H !== ""
																? u
																...
																|| H === "0"
																? u
																		.addClass("ke-zeroborder")
																: u
																		.removeClass("ke-zeroborder"), U !== ""
																? u
																		.attr(
																				"borderColor",
																				U)
																: u
																		.removeAttr("borderColor"), e
																.hideDialog()
																.focus(), e.cmd.range
																.moveToBookmark(l), e.cmd
																.select();
													else {
														var S = "";
														h !== ""
													...
													alert(e
															.lang("invalidBorder")), G[0]
															.focus();
											else
												alert(e.lang("invalidSpacing")), A[0]
														.focus();
										else
											alert(e.lang("invalidPadding")), q[0]
													.focus();
									else
										alert(e.lang("invalidHeight")), r[0]
												.focus();
								else
									alert(e.lang("invalidWidth")), p[0].focus()
							}
						}
					}).div, j = b('[name="rows"]', o).val(3), m = b(
					'[name="cols"]', o).val(2), p = b('[name="width"]', o)
					.val(100), r = b('[name="height"]', o), z = b(
					'[name="widthType"]', o), D = b('[name="heightType"]', o), q = b(
					'[name="padding"]', o).val(2), A = b('[name="spacing"]', o)
					.val(0), B = b('[name="align"]', o), G = b(
					'[name="border"]', o).val(1), C = b(".ke-input-color", o);
			f(o, C.eq(0));
			f(o, C.eq(1));
			d(C.eq(0), "#000000");
			d(C.eq(1), "");
			...
			if (!n && (u = e.plugin.getSelectedTable())) {
				...
				j.attr("disabled", !0);
				m.attr("disabled", !0);
				var I, n = u[0].style.width || u[0].width, o = u[0].style.height
						|| u[0].height;
				n !== void 0 && (I = /^(\d+)((?:px|%)*)$/.exec(n)) ? (p
						.val(I[1]), z.val(I[2])) : p.val("");
		...
		cellprop : function() {
			var n = [
					...
					'<option value="baseline">' + h.alignBaseline + "</option>",
					'</select></div><div class="ke-dialog-row">',
					'<label for="keBorder" style="width:90px;">' + h.border
							+ "</label>",
					h.borderWidth
					...
					'<label for="keBgColor" style="width:90px;">'
							+ h.backgroundColor + "</label>",
					'<span class="ke-inline-block ke-input-color"></span></div></div>']
					.join(""), o = e.cmd.range.createBookmark(), n = e
					.createDialog({
						name : "table",
						width : 500,
						...
						yesBtn : {
							name : e.lang("yes"),
							click : function() {
								var d = l.val(), f = j.val(), h = m.val(), n = p
										.val();
								r.val();
								z.val();
								var C = D.val(), $ = q.val(), M = A.val(), K = b(B[0])
										.html()
										|| "", O = b(B[1]).html() || "";
								/^\d*$/.test(d) ? /^\d*$/.test(f)
										? /^\d*$/.test(M)
												? (G.css({
														...
														.focus(), e.cmd.range
														.moveToBookmark(o), e.cmd
														.select(), e
														.addBookmark())
												: (alert(e
														.lang("invalidBorder")), A[0]
														.focus())
										: (alert(e.lang("invalidHeight")), j[0]
												.focus())
										: (alert(e.lang("invalidWidth")), l[0]
												.focus())
							}
						}
					}).div, l = b('[name="width"]', n).val(100), j = b(
					'[name="height"]', n), m = b('[name="widthType"]', n), p = b(
					'[name="heightType"]', n), r = b('[name="padding"]', n)
					.val(2), z = b('[name="spacing"]', n).val(0), D = b(
					'[name="textAlign"]', n), q = b('[name="verticalAlign"]', n), A = b(
					'[name="border"]', n).val(1), B = b(".ke-input-color", n);
			f(n, B.eq(0));
			f(n, B.eq(1));
			d(B.eq(0), "#000000");
			d(B.eq(1), "");
			l[0].focus();
			l[0].select();
			var G = e.plugin.getSelectedCell(), C = G[0].style.height
					|| G[0].height || "";
			(n = /^(\d+)((?:px|%)*)$/
					.exec(G[0].style.width || G[0].width || ""))
					? (l.val(n[1]), m.val(n[2]))
					: l.val("");
			if (n = /^(\d+)((?:px|%)*)$/.exec(C))
				j.val(n[1]), p.val(n[2]);
		...
		colinsert : function(d) {
			var f = e.plugin.getSelectedTable()[0], h = e.plugin
					.getSelectedRow()[0], m = e.plugin.getSelectedCell()[0], d = m.cellIndex
					+ d;
		...
		rowinsert : function(d) {
			var f = e.plugin.getSelectedTable()[0], h = e.plugin
					.getSelectedRow()[0], j = e.plugin.getSelectedCell()[0], m = h.rowIndex;
		...
		rowmerge : function() {
			var b = e.plugin.getSelectedTable()[0], d = e.plugin
					.getSelectedRow()[0], f = e.plugin.getSelectedCell()[0], h = d.rowIndex
					+ f.rowSpan, d = b.rows[h];
			if (!(b.rows.length <= h))
				b = f.cellIndex, d.cells.length <= b
						|| (h = d.cells[b], f.colSpan === h.colSpan
								&& (f.rowSpan += h.rowSpan, d.deleteCell(b), e.cmd.range
										.selectNodeContents(f).collapse(!0), e.cmd
										.select(), e.addBookmark()))
		},
		colmerge : function() {
			e.plugin.getSelectedTable();
			var b = e.plugin.getSelectedRow()[0], d = e.plugin
					.getSelectedCell()[0], f = d.cellIndex + 1;
			if (!(b.cells.length <= f)) {
				var h = b.cells[f];
				d.rowSpan === h.rowSpan
						&& (d.colSpan += h.colSpan, b.deleteCell(f), e.cmd.range
								.selectNodeContents(d).collapse(!0), e.cmd
								.select(), e.addBookmark())
			}
		},
		rowsplit : function() {
			var d = e.plugin.getSelectedTable()[0], f = e.plugin
					.getSelectedRow()[0], h = e.plugin.getSelectedCell()[0], m = f.rowIndex;
			if (h.rowSpan !== 1) {
		...
		colsplit : function() {
			e.plugin.getSelectedTable();
			var d = e.plugin.getSelectedRow()[0], f = e.plugin
					.getSelectedCell()[0], h = f.cellIndex;
			if (f.colSpan !== 1) {
		...
		coldelete : function() {
			for (var d = e.plugin.getSelectedTable()[0], f = e.plugin
					.getSelectedRow()[0], h = e.plugin.getSelectedCell()[0].cellIndex, j = 0, m = d.rows.length; j < m; j++) {
				var p = d.rows[j], r = p.cells[h];
				r.colSpan > 1 ? (r.colSpan -= 1, r.colSpan === 1
						&& b(r).removeAttr("colSpan")) : p.deleteCell(h);
				r.rowSpan > 1 && (j += r.rowSpan - 1)
			}
			f.cells.length === 0
					? (e.cmd.range.setStartBefore(d).collapse(!0), e.cmd
							.select(), b(d).remove())
					: e.cmd.selection(!0);
			e.addBookmark()
		},
		rowdelete : function() {
			for (var d = e.plugin.getSelectedTable()[0], f = e.plugin
					.getSelectedRow()[0], h = e.plugin.getSelectedCell()[0], f = f.rowIndex, h = h.rowSpan
					- 1; h >= 0; h--)
				d.deleteRow(f + h);
			d.rows.length === 0
					? (e.cmd.range.setStartBefore(d).collapse(!0), e.cmd
...
KindEditor.plugin("template", function(b) {
	function d(d) {
		return j + d + "?ver="
				+ encodeURIComponent(b.DEBUG ? b.TIME : b.VERSION)
	}
	var f = this;
	f.lang("template.");
	var j = f.pluginsPath + "template/html/";
	f.clickToolbar("template", function() {
		var e = f.lang("template."), h = ['<div style="padding:10px 20px;">',
				'<div class="ke-header">', '<div class="ke-left">',
		...
		html = [
				h.join(""),
				'</select></div><div class="ke-right">',
				'<input type="checkbox" id="keReplaceFlag" name="replaceFlag" value="1" /> <label for="keReplaceFlag">'
						+ e.replaceContent + "</label>",
				'</div><div class="ke-clearfix"></div></div><iframe class="ke-textarea" frameborder="0" style="width:458px;height:260px;background-color:#FFF;"></iframe></div>']
				.join("");
		var e = f.createDialog({
					...
					yesBtn : {
						...
						click : function() {
							var d = b.iframeDoc(o);
							f[n[0].checked ? "html" : "insertHtml"](d.body.innerHTML)
									.hideDialog().focus()
						}
					}
				}), j = b("select", e.div), n = b('[name="replaceFlag"]', e.div), o = b(
				"iframe", e.div);
		n[0].checked = !0;
		o.attr("src", d(j.val()));
		j.change(function() {
...
KindEditor.plugin("wordpaste", function(b) {
	...
	d.clickToolbar("wordpaste", function() {
		var f = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">'
				...
				+ '</div><iframe class="ke-textarea" frameborder="0" style="width:408px;height:260px;"></iframe></div>', f = d
				.createDialog({
							name : "wordpaste",
							width : 450,
