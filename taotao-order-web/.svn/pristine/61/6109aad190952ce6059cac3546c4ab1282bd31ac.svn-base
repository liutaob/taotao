...
(function($) {
	...
	function _37(_38, _39) {
		...
		for (var i = 0; i < _39.length; i++) {
			var _3f = $("<input type=\"hidden\" class=\"textbox-value\">")
					.appendTo(_3c);
			_3f.attr("name", _3e);
			if (_3b.disabled) {
					...
					if (_4e) {
						...
						_4e = $.data(this, "combo", {
									options : $.extend({}, $.fn.combo.defaults,
											$.fn.combo.parseOptions(this), _4b),
									previousText : ""
								});
	...
	$.fn.combo.parseOptions = function(_55) {
		var t = $(_55);
		return $.extend({}, $.fn.textbox.parseOptions(_55), $.parser
						.parseOptions(_55, ["separator", "panelAlign", {
											panelWidth : "number",
