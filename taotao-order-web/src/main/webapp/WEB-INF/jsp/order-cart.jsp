...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function cop(){
		...
		document.getElementById("receiverName2").value = receiverName;

		var receiverMobile=document.getElementById("receiverMobile").value;
		document.getElementById("receiverMobile2").value = receiverMobile;

		var receiverState=document.getElementById("receiverState").value;
		document.getElementById("receiverState2").value = receiverState;

		var receiverCity=document.getElementById("receiverCity").value;
		document.getElementById("receiverCity2").value = receiverCity;

		var receiverAddress=document.getElementById("receiverAddress").value;
		document.getElementById("receiverAddress2").value = receiverAddress;
	}
</script>
...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://localhost:8082"><img src="/images/taotao-logo.gif" alt="返回淘淘商城首页"></a></div>
</div>
...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" id="receiverName2"/>
		<input type="hidden" name="orderShipping.receiverMobile" id="receiverMobile2"/>
		<input type="hidden" name="orderShipping.receiverState" id="receiverState2"/>
		<input type="hidden" name="orderShipping.receiverCity" id="receiverCity2"/>
		<input type="hidden" name="orderShipping.receiverAddress" id="receiverAddress2"/>
</form>
...
<div class="step-cont">
	<div class="consignee-list" id="consignee-list1">
		...
		<div id="consignee1" class="list-cont ui-switchable-body">
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<b></b>
						<div>
							<span style="color: red">*姓名：</span><input type="text" maxlength="4" value= "${user.username}" placeholder="${user.username}" id="receiverName" onpropertychange="cop()" oninput="cop()"></input><br>
							<span style="color: red">*手机：</span><input type="text" maxlength="11" value= "${user.phone}" placeholder="${user.phone}" id="receiverMobile" onpropertychange="cop()" oninput="cop()"></input></br>
			<span style="color: red">*省份：</span>
			<select id="receiverState" onpropertychange="cop()" oninput="cop()">
      		<optgroup label="省份">
			...
			<select id="receiverCity" onpropertychange="cop()" oninput="cop()>
      		<optgroup label="城市">
      			<option value="jx">南昌</option>
	      		<option value="js">宜春</option>
	      		<option value="gx">九江</option>
      		</optgroup>
      	</select><br>
							<span style="color: red">*地址：</span><input type="text" maxlength="15" id="receiverAddress" onpropertychange="cop()" oninput="cop()"></input>
						</div>
						</div>
					</div>
				</li>
    ...
    <div class="goods-suit goods-last">
	 <c:forEach items="${cartList }" var="cart">
		<div class="goods-item goods-item-extra">
			...
			<div class="p-img">
				<a target="_blank" href="http://localhost:8089/item/${cart.id}.html">
					<img src="${cart.image}" alt="">
				</a>
			</div>
			<div class="goods-msg">
				<div class="p-name">
					<a href="http://localhost:8089/item/${cart.id}.html" target="_blank">
						${cart.title } 
					</a>
				</div>
				<div class="p-price">
