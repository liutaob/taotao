...
(function($) {
			...
			if (_1b.title && !_1b.noheader) {
				...
				if (_1b.collapsible) {
					$("<a class=\"panel-tool-collapse\" href=\"javascript:void(0)\"></a>")
							.appendTo(_24).bind("click", function() {
	...
	function _25(_26, _27) {
		...
		if (!_28.isLoaded || !_29.cache) {
			...
			if (_29.loadingMessage) {
				$(_26).html($("<div class=\"panel-loading\"></div>")
						.html(_29.loadingMessage));
			}
	...
	function _31(_32, _33) {
		...
		function cb() {
			_34.closed = false;
			_34.minimized = false;
			var _36 = _35.children("div.panel-header")
	...
	function _38(_44, _45) {
		...
		var _49 = _47.children("div.panel-header")
	...
	function _4a(_4b, _4c) {
		...
		var _50 = _4e.children("div.panel-header")
				.find("a.panel-tool-collapse");
	...
	$.fn.panel = function(_63, _64) {
		...
		return this.each(function() {
					...
					if (_65) {
						...
						_66 = $.extend({}, $.fn.panel.defaults, $.fn.panel
			...
			return jq.each(function() {
				...
				function _6f(_70, _71) {
					...
					var s = $(_70)
							...
							.filter(function(_73, el) {
								var p = $(el).parents("div.panel-" + _71
										+ ":first");
	...
	$.fn.panel.parseOptions = function(_77) {
		var t = $(_77);
		return $.extend({}, $.parser.parseOptions(_77, ["id", "width",
