...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://localhost:8082" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="/images/taotao-logo.gif" width="270" height="60" alt="返回淘淘商城首页"></a></div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="nav-2013">
			<div id="categorys-2013" class="categorys-2014">
				...
				<div id="_JD_ALLSORT" class="mc">
					<c:forEach items="${allItemCatList}" var="itemCat">
						<div class="item fore1">
							<span data-split="1"><h3>
									<a href="http://localhost:8085/search.html?q=${itemCat.name}">${itemCat.name}</a>
								</h3> <s></s></span>
						</div>
					</c:forEach>
					<!-- <div class="item fore1">
